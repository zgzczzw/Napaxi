...
#undef GRP8
                ...
                // three-byte opcode 0F 38 xx (SSSE3/SSE4.1)
                case 0x38:
                    READINSN;
                    switch (insn) {
                        // SSSE3
                        ...
                        // SSE4.1 blendv (implicit XMM0 mask)
                        case 0x10: TRACEI("pblendvb xmm:modrm, xmm");
                                   READMODRM; V_OP(pblendvb, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x14: TRACEI("blendvps xmm:modrm, xmm");
                                   READMODRM; V_OP(blendvps, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x15: TRACEI("blendvpd xmm:modrm, xmm");
                        ...
                        case 0x20: TRACEI("pmovsxbw xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovsxbw, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x21: TRACEI("pmovsxbd xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovsxbd, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x22: TRACEI("pmovsxbq xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovsxbq, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x23: TRACEI("pmovsxwd xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovsxwd, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x24: TRACEI("pmovsxwq xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovsxwq, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x25: TRACEI("pmovsxdq xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovsxdq, xmm_modrm_val, xmm_modrm_reg,128); break;
                        ...
                        case 0x29: TRACEI("pcmpeqq xmm:modrm, xmm");
                                   READMODRM; V_OP(compare_eqq, xmm_modrm_val, xmm_modrm_reg,128); break;
                        ...
                        case 0x30: TRACEI("pmovzxbw xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovzxbw, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x31: TRACEI("pmovzxbd xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovzxbd, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x32: TRACEI("pmovzxbq xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovzxbq, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x33: TRACEI("pmovzxwd xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovzxwd, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x34: TRACEI("pmovzxwq xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovzxwq, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x35: TRACEI("pmovzxdq xmm:modrm, xmm");
                                   READMODRM; V_OP(pmovzxdq, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x37: TRACEI("pcmpgtq xmm:modrm, xmm");
                                   READMODRM; V_OP(compares_gtq, xmm_modrm_val, xmm_modrm_reg,128); break;
                        ...
                        case 0x2a: TRACEI("movntdqa xmm:modrm, xmm");
                                   READMODRM; VMOV(xmm_modrm_val, xmm_modrm_reg,128); break;
                        ...
                        default: TRACEI("undefined 0f38"); UNDEFINED;
                    }
                    break;

                // three-byte opcode 0F 3A xx (SSE4.1 imm8)
                case 0x3a:
                    READINSN;
                    switch (insn) {
                        case 0x08: TRACEI("roundps xmm:modrm, xmm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(roundps, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x09: TRACEI("roundpd xmm:modrm, xmm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(roundpd, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x0a: TRACEI("roundss xmm:modrm, xmm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(roundss, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x0b: TRACEI("roundsd xmm:modrm, xmm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(roundsd, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x0c: TRACEI("blendps xmm:modrm, xmm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(blendps, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x0d: TRACEI("blendpd xmm:modrm, xmm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(blendpd, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x0e: TRACEI("pblendw xmm:modrm, xmm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(pblendw, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x0f: TRACEI("palignr xmm:modrm, xmm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(palignr, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x14: TRACEI("pextrb xmm, modrm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(pextrb, xmm_modrm_reg, modrm_val,128); break;
                        case 0x16: TRACEI("pextrd xmm, modrm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(pextrd, xmm_modrm_reg, modrm_val,128); break;
                        case 0x17: TRACEI("extractps xmm, modrm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(extractps, xmm_modrm_reg, modrm_val,128); break;
                        case 0x20: TRACEI("pinsrb xmm, modrm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(pinsrb, modrm_val, xmm_modrm_reg,128); break;
                        case 0x21: TRACEI("insertps xmm, modrm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(insertps, xmm_modrm_val, xmm_modrm_reg,128); break;
                        case 0x22: TRACEI("pinsrd xmm, modrm, imm8");
                                   READMODRM; READIMM8; V_OP_IMM(pinsrd, modrm_val, xmm_modrm_reg,128); break;
                        default: TRACEI("undefined 0f3a"); UNDEFINED;
                    }
                    break;
                ...
                case 0x0f:
                    ...
                    switch (insn) {
                        ...
                        case 0x12: TRACEI("movddup xmm:modrm, xmm");
                                   READMODRM; V_OP(movddup, xmm_modrm_val, xmm_modrm_reg,128); break;
                        ...
                        case 0xf0: TRACEI("lddqu xmm:modrm, xmm");
                                   READMODRM; VMOV(xmm_modrm_val, xmm_modrm_reg,128); break;
            ...
            switch (insn) {
                case 0x0f:
                    ...
                    switch (insn) {
                        ...
                        case 0xb8: TRACEI("popcnt modrm, reg (unsupported)");
                                   READMODRM; UNDEFINED; break;
